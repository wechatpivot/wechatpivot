...
module.exports = class ApiController extends Controller {
  ...
  async messageInVerify() {
    ...
    // ctx.logger.info(signature, timestamp, nonce, token, echostr);
  ...
  async messageIn() {
    ...
    const message = await wechatMessage.receive(ctx.request.body);
    ctx.logger.info(message);
    await ctx.service.messageIn.broadcast(message);
